        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Horizontal Form -->
              <form action="{{url('/pelatihan/edit-post', $data->id)}}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                <div class="col-md-6">
                    <div class="form-floating">
                      <input type="text" class="form-control" name="judul" id="floatingName" value="{{$data->judul}}" placeholder="Judul Pelatihan" required>
                      <label for="floatingName">Judul Pelatihan</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating">
                      <input type="text" class="form-control" name="harga" id="Harga" value="{{$data->harga}}" placeholder="Harga Pelatihan" required>
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                      <input type="text" class="form-control" name="deskripsi" value="{{$data->deskripsi}}" id="floatingName1" placeholder="Deksripsi Singkat" required>
