...
@foreach ($data as $item)
    ...
    <div id="background-image-container" class="background-image-container">
        ...
        <tr>
          ...
          <td colspan="6" id="nomor">No : {{$item->nomor}}</td>
        <thead>
        <br>
          <tr>
            <td colspan="5"> &nbsp;{{$item->instansi}}</td>
          </tr>
          <tr>
            <td colspan="6"> &nbsp;&nbsp;{{$item->hal}}</td>
          </tr>
          <tr>
            <td colspan="4"></td>
          ...
          <tbody>
            <tr>
                <th> </th>
                <td colspan="2">{{ 'Rp ' . number_format($item->terbilang, 0, ',', '.') }}</td>
                {{-- <td colspan="2"></td> --}}
            </tr>
          </tbody>
          <tfoot>
