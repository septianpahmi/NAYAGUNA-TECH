        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Horizontal Form -->
              <form action="{{url('/sertifikat/post')}}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                <div class="col-md-2">
                ...
                <div class="col-md-10">
                    <div class="form-floating">
                      <input type="text" class="form-control" name="judul" id="floatingName" placeholder="Judul Sertifikat" required>
                ...
                <div class="col-md-4">
                    <div class="form-floating">
                      <input type="text" class="form-control" name="tgl_lahir" id="Harga" placeholder="Tanggal Lahir" required>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$item->pelatihanId->kategori}}</td>
                    <td>{{$item->status}}</td>
                    <td> <img src="Sertifikat/{{$item->foto}}" alt="Profile" style="max-width: 100%; max-height: 50px;" class="rounded-circle"></td>
                    <td>
                      <a href="{{url('/sertifikat/print',$item->id)}}" type="button" target="__blank" class="btn btn-success">Print</a>
                      <a href="{{url('/sertifikat/edit', $item->id)}}" style="button" class="btn btn-warning">Edit</a>
                      <a href="{{url('/sertifikat/delete', $item->id)}}" style="button" onclick="return confirm('Yakin ingin menghapus?')" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
